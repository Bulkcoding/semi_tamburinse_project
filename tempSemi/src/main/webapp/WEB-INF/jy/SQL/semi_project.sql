...
,store_country     Nvarchar2(2)    not null  -- 매장 국가 (kr, cn)
...
alter table tbl_store rename column fk_country_code to fk_cty_code;
--Table TBL_STORE이(가) 변경되었습니다.

alter table tbl_store
add constraint FK_tbl_store_fk_cty_code foreign key(fk_cty_code) references tbl_store_country(cty_code);
...
insert into tbl_store(store_no, store_country, store_name, store_address, store_contact, store_hours, store_ca)
values(seq_tbl_store_no.nextval, 'kr', '플래그십스토어 삼청', '서울 종로구 율곡로3길 84', '+82 70 4139 7450', '월-일 11:00am-8:00pm', 'flg');

insert into tbl_store(store_no, store_country, store_name, store_address, store_contact, store_hours, store_ca)
values(seq_tbl_store_no.nextval, 'kr', '하우스 도산', '서울 강남구 압구정로46길 50', '+82 70 4128 2124', '월-일 11:00am-9:00pm', 'flg');

insert into tbl_store(store_no, store_country, store_name, store_address, store_contact, store_hours, store_ca)
values(seq_tbl_store_no.nextval, 'kr', '플래그십스토어 신사', '서울 강남구 압구정로10길 44', '+82 02 511 1246', '월-일 12:00pm-9:00pm', 'flg');
